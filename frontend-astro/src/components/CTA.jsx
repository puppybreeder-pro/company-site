            ...
            <Card className="p-8 bg-card">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <FormField label="Phone Number (Optional)" htmlFor="phone">
                  <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="(555) 123-4567" className="w-full" />
                </FormField>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Prefer to talk first? Book a free 30-minute demo call to see if we're the right fit.
                    </p>
              ...
              <Card className="p-6 bg-primary/5 border-primary/20">
                ...
                <ul className="space-y-3 text-sm text-foreground/80">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>Schedule a quick 30-minute call to finalize your design preferences</span>
                  </li>
                  <li className="flex gap-2">
