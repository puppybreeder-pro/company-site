...
export const Hero = () => {
  const {
    ...
    HERO_FORM_INITIAL,
    {
      title: "You're in!",
      description:
        "We'll reach out within 24 hours to set up your free 30-min demo.",
    },
    {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="pb-12 lg:pb-20">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed animate-fade-in-up max-w-xl">
              Relax. Stop fighting with website builders. Get a beautiful site
              that you can actually manage — without any tech headaches. We're
              here to help you every 🐾.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-3 animate-fade-in-up">
              Free 30-min call. No credit card. No hard sell.
            </p>
